...
class JaroWinkler
{
    ...
    {
        return self::JaroWinkler($str1, $str2, $PREFIXSCALE = 0.1);
    }
    ...
    private static function jaro($string1, $string2)
    {
    ...
    private static function getPrefixLength($string1, $string2, $MINPREFIXLENGTH = 4)
    {
    ...
    private static function JaroWinkler($string1, $string2, $PREFIXSCALE = 0.1)
    {

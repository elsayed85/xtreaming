...
<div class="app-content pt-md-3">
        ...
        <div class="app-slider">
            <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item ">
                        <a href="https://demo.codelug.com/wovie/movie/mad-max-fury-road-7" class="slide media media-slide"
    ...
    <div class="app-section">
        <div class="app-trailer">
            <div class="row row-cols-7 list-story">
                <div class="col">
                    <a href="https://demo.codelug.com/wovie/movie/captain-americathe-first-avenger-10" class="list-trailer">
                ...
                <div class="col">
                    <a href="https://demo.codelug.com/wovie/serie/chilling-adventures-of-sabrina-22" class="list-trailer">
                        <div class="media-story active" style="background-color: #f5c518">
                            <div class="media"
    ...
    <div class="app-section">
        ...
        <div class="row row-cols-5 list-scrollable">
            ...
            <div class="col">
                <div class="list-movie">
                    <a href="https://demo.codelug.com/wovie/movie/captain-americathe-first-avenger-10" class="list-media">
                        <div class="list-media-attr">
                            <div class="quality">
                                Ultra HD </div>
                            <div class="imdb">
            ...
            <div class="col">
                <div class="list-movie">
                    ...
                    <div class="list-caption">
                        <a href="https://demo.codelug.com/wovie/movie/the-shawshank-redemption-5" class="list-titlesub">
                            The Shawshank Redemption </a>
                        <a href="https://demo.codelug.com/wovie/movie/the-shawshank-redemption-5" class="list-title">
                            The Shawshank Redemption</a>
                        <a href="https://demo.codelug.com/wovie/movie/the-shawshank-redemption-5" class="list-category">
                            Drama</a>
                    </div>
                </div>
            </div>
    ...
    <div class="app-section">
        ...
        <div class="row row-cols-5 list-scrollable">
            <div class="col">
                <div class="list-movie">
                    <a href="https://demo.codelug.com/wovie/serie/chilling-adventures-of-sabrina-22" class="list-media">
                        <div class="list-media-attr">
                            <div class="quality">
                                HD </div>
                            <div class="imdb">

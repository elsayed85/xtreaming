...
@section('main')
    <div class="layout-section">
        ...
        <div class="layout-section">
            <div class="row mb-4">
                <div class="col-auto">
                    <a href="https://demo.codelug.com/xtreaming/user/admin" class="d-block" data-bs-tooltip="tooltip"
                        data-bs-placement="top" title="" data-bs-original-title="Xtreaming - @admin">
                        <div class="avatar avatar-xl rounded-circle text-white fs-xs" style="background-color:#864bfc;">A
                        </div>
                    </a>
                </div>
                <div class="col-lg text-gray-600">
                    ...
                    <ul class="list-inline list-separator fs-xs text-gray-500">
                        ...
                        <li class="list-inline-item text-heading">
                            <a href="https://demo.codelug.com/xtreaming/collection/the-best-tv-and-movies-to-watch-in-jun-3?_ACTION=edit"
                                class="text-current fw-semibold">
                                Edit</a>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-auto">
                            <div class="w-lg-75px">
                                <picture>
                                    ...
                                    <img src="https://demo.codelug.com/xtreaming/public/upload/post/t0VKzmt2Ed.png"
                                        data-src="https://demo.codelug.com/xtreaming/public/upload/post/t0VKzmt2Ed.png"
                                        alt="" class="img-fluid rounded-1 ls-is-cached lazyloaded" width="100"
                                        height="auto">
                                </picture>
                            </div>
                        </div>
                        <div class="col-lg">
                            ...
                            <a href="https://demo.codelug.com/xtreaming/movie/the-black-phone"
                                class="fw-semibold text-current fs-base d-inline-block mb-2">
                                The Black Phone</a>
                            <div class="fs-xs h-2x text-muted">
                                Finney Blake, a shy but clever 13-year-old boy, is abducted by a sadistic killer and trapped
                                in a soundproof basement where screaming is of little use. When a disconnected phone on the
                                wall begins to ring, Finney discovers that he can hear the voices of the killer’s previous
                                victims. And they are dead set on making sure that what happened to them doesn’t happen to
                                Finney. </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <div class="fs-xs h-2x text-muted">
                                ...
                                advancement in rank that would ground him, Pete “Maverick” Mitchell finds himself training a
                                detachment of TOP GUN graduates for a specialized mission the likes of which no living pilot
                                has ever seen. </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        ...
                        <div class="col-lg">
                            <div class="fs-xs text-muted">
                                Black Site </div>
                            <a href="https://demo.codelug.com/xtreaming/movie/black-site"
                                class="fw-semibold text-current fs-base d-inline-block mb-2">
                                Black Site</a>
                            <div class="fs-xs h-2x text-muted">
                                A group of officers based in a labyrinthine top-secret prison must fight for their lives
                                against Hatchet, a brilliant and infamous high-value detainee. When he escapes, his
                                mysterious and deadly agenda has far reaching and dire consequences. </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <a href="https://demo.codelug.com/xtreaming/serie/a-family-affair"
                                ...
                                A Family Affair</a>
                            <div class="fs-xs h-2x text-muted">
                                An inheritance from the late matriarch of the Estrellas intertwines the life of Cherry Red
                                with Dave, Paco, Seb, and Drew. Amid the romance that arose between her and two of the four
                                brothers, Cherry's past unravels and exposes deeply buried secrets. </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <a href="https://demo.codelug.com/xtreaming/serie/the-secret-house"
                                ...
                                The Secret House</a>
                            <div class="fs-xs h-2x text-muted">
                                A story about quitting being a good boy and chasing evil to the end for the sake of the
                                mother and sister who sacrificed for themselves.
                                A revenge play in which a dirt spoon lawyer chasing the traces of his missing mother walks
                                into the secret surrounding him to fight the world. </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-auto">
                            <div class="w-lg-75px">
                                <picture>
                                    ...
                                    <img src="https://demo.codelug.com/xtreaming/public/upload/post/aIRzeHI1nV.png"
                        ...
                        <div class="col-lg">
                            ...
                            <a href="https://demo.codelug.com/xtreaming/movie/the-next-365-days"
                                ...
                                The Next 365 Days</a>
                            <div class="fs-xs h-2x text-muted">
                                Laura and Massimo's relationship hangs in the balance as they try to overcome trust issues
                                while a tenacious Nacho works to push them apart. </div>
                        </div>
                    </div>
                </div>
            </div>

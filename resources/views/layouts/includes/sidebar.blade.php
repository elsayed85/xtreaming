<div class="app-aside nav-aside" id="aside">
    ...
    <ul class="nav">
        <li class="active">
            <a href="https://demo.codelug.com/wovie/">
                <svg class="nav-icon">
        ...
        <li>
            <a href="https://demo.codelug.com/wovie/actors">
                <svg class="nav-icon">
        ...
        <li>
            <a href="https://demo.codelug.com/wovie/tv-channels">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('images/sprite.svg') }}#tv" />
                </svg>
                TV Channels</a>
        ...
        <li class="nav-header">
            Discovery </li>
        <li>
            <a href="https://demo.codelug.com/wovie/categories">
                <svg class="nav-icon">
        ...
        <li>
            <a href="https://demo.codelug.com/wovie/collections">
                <svg class="nav-icon">
